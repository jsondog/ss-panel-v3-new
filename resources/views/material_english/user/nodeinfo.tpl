								...
								<div class="card-main">
									<div class="card-inner margin-bottom-no">
										...
										<div class="tab-pane fade {if $ssr_prefer}active in{/if}" id="ssr_download">
											{if URL::SSRCanConnect($user, $mu)}
												<p><i class="icon icon-lg">desktop_windows</i>&nbsp;<a href="https://d.laoahong.net/sspanelv3/ssr-download/ssr-win.7z">Windows</a></p>
												<p><i class="icon icon-lg">laptop_mac</i>&nbsp;<a href="https://d.laoahong.net/sspanelv3/ssr-download/ssr-mac.dmg">Mac OS X</a></p>
												<p><i class="icon icon-lg">laptop_windows</i>&nbsp;<a href="https://github.com/breakwa11/shadowsocks-rss/wiki/Python-client">Linux</a></p>
												<p><i class="icon icon-lg">android</i>&nbsp;<a href="https://d.laoahong.net/sspanelv3/ssr-download/ssr-android.apk">Android</a></p>
										...
										<div class="tab-pane fade {if !$ssr_prefer}active in{/if}" id="ss_download">
											{if URL::SSCanConnect($user, $mu)}
												<p><i class="icon icon-lg">desktop_windows</i>&nbsp;<a href="https://d.laoahong.net/sspanelv3/ssr-download/ss-win.7z">Windows</a></p>
												<p><i class="icon icon-lg">laptop_mac</i>&nbsp;<a href="https://d.laoahong.net/sspanelv3/ssr-download/ss-mac.zip">Mac OS X</a></p>
												<p><i class="icon icon-lg">laptop_windows</i>&nbsp;<a href="https://shadowsocks.org/en/download/clients.html">Linux</a></p>
												<p><i class="icon icon-lg">android</i>&nbsp;<a href="https://d.laoahong.net/sspanelv3/ssr-download/ss-android.apk">Android</a></p>
												<p><i class="icon icon-lg">android</i>&nbsp;<a href="https://d.laoahong.net/sspanelv3/ssr-download/ss-android-obfs.apk">Android Obfs Plugin</a></p>
												<p><i class="icon icon-lg">phone_iphone</i>&nbsp;<a href="https://itunes.apple.com/us/app/shadowrocket/id932747118">iOS</a></p>
											{else}
												<p>Your current encryption type, obfuscation type, or protocol will not work with the Shadowsocks client. Please use the ShadowsocksR client to connect, or to the edit details page to change them to compatible types before coming back here.</p>
											{/if}
...
<script src="https://b.laoahong.net/sspanelv3/assets/public/js/jquery.qrcode.min.js"></script>
<script>
	{if URL::SSCanConnect($user, $mu)}
