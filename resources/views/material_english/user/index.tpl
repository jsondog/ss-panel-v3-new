											...
											<div class="tab-content">
												<div class="tab-pane fade {if $ssr_prefer}active in{/if}" id="all_ssr">
													...
													<div class="tab-pane fade" id="all_ssr_windows">
														<p><a href="https://d.laoahong.net/sspanelv3/ssr-download/ssr-win.7z">Download</a> and unzip the file. Double-click on the ShadowsocksR file to start the app. You now have three ways to import the servers:<br>
													...
													<div class="tab-pane fade" id="all_ssr_mac">
														<p><a href="https://d.laoahong.net/sspanelv3/ssr-download/ssr-mac.dmg">Download</a>, install, and then download <a href="/user/getpcconf?is_mu=0&is_ss=0">this (default)</a> or <a  href="/user/getpcconf?is_mu=1&is_ss=0">this (single-port multi-user)</a>. Run the vpn software. You should see a small paper airplane icon on the top right of your screen. Right-click it, and go to servers -> "import bunch JSON file".</p>
												...
												<div class="tab-pane fade {if !$ssr_prefer}active in{/if}" id="all_ss">
													...
													<div class="tab-pane fade" id="all_ss_windows">
														<p><a href="https://d.laoahong.net/sspanelv3/ssr-download/ss-win.zip">Download</a>, extract, and run the program. You have two ways to import all nodes:<br>
