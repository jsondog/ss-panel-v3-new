...
<script src="https://b.laoahong.net/sspanelv3/theme/material/js/base.min.js"></script>
<script src="https://b.laoahong.net/sspanelv3/theme/material/js/project.min.js"></script>
