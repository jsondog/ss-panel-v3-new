					...
					<div class="card margin-bottom-no">
						<div class="card-main">
							<div class="card-inner">
								<h4>注意!</h4>
								<p>如果你流量不够用的话，请支持我一下，先<a href="/user/code">充值金额</a>，然后在<a href="/user/shop">商店购买套餐</a>即可</p>
								<p style="color: #33CC66;">新注册用户可免费使用24小时VIP节点，过期需要<a href="/user/shop">购买套餐</a>继续使用</p>
								<p>如果你不会配置使用，请查看<a href="/user">All-in-One栏目</a></p>
								<a href="javascript:void(0);" onClick="urlChange('guide',0,0,0)">点我教你使用方法</a>
							</div>
						</div>
					</div>
				</div>
											...
											<div class="tile tile-collapse">
												<div data-toggle="tile" data-target="#heading{$node_order->$prefix}">
													...
													<div class="tile-inner">
																...
																<span style="bold;color:#0000FF"><div i class="text-overflow">{$prefix} | <span style="bold;color:#FF00FF"><i class="icon icon-lg">person</i> {$node_alive[$prefix]} |  <span style="bold;color:#008000"><i class="icon icon-lg">build</i> {$node_method[$prefix]} | <span style="bold;color:#FF0000"><i class="icon icon-lg">traffic</i> {if isset($node_bandwidth[$prefix])==true}{$node_bandwidth[$prefix]}{else}N/A{/if}</div>
													</div>
												</div>
