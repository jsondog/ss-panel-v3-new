							...
							<div class="card">
								<div class="card-main">
									<div class="card-inner margin-bottom-no">
										<p class="card-heading">官方QQ群：138945469 </p>
										<p>余额不足？点我<a href="/user/code"/>在线充值</a></p>
										<p>流量不够？点我<a href="/user/shop"/>购买套餐</a></p>
										<p>不会使用？点我<a href="/user/node"/>查看使用方法</a></p>
										{if $ann != null}
										<p>{$ann->content}</p>
										{/if}
									</div>
											...
											<div class="tab-content">
												<div class="tab-pane fade {if $ssr_prefer}active in{/if}" id="all_ssr">
													...
													<div class="tab-pane fade" id="all_ssr_windows">
														<p><a href="https://d.laoahong.net/sspanelv3/ssr-download/ssr-win.zip">下载</a>，解压，运行程序，然后您有三种方式导入所有节点<br>
															...
															然后选择一个合适的服务器，系统代理模式选”PAC模式”，代理规则选“绕过局域网和大陆”，然后即可上网。</p>
													...
													<div class="tab-pane fade" id="all_ssr_mac">
														<p><a href="https://d.laoahong.net/sspanelv3/ssr-download/ssr-mac.dmg">下载</a>，安装，然后下载<a href="/user/getpcconf?is_mu=0&is_ss=0">这个(普通端口)</a>或者<a  href="/user/getpcconf?is_mu=1&is_ss=0">这个（单端口多用户）</a>，运行程序，小飞机上右键 服务器列表 子菜单 的 “导入服务器配置文件...” 导入这个文件，然后选择一个合适的服务器，更新一下PAC，然后开启系统代理即可上网。</p>
													</div>
													...
													<div class="tab-pane fade" id="all_ssr_android">
														<p><a href="https://d.laoahong.net/sspanelv3/ssr-download/ssr-android.apk">下载</a>，安装，然后在手机上默认浏览器中点击<a href="{$ssr_url_all}">这个链接（普通端口）</a>或者<a href="{$ssr_url_all_mu}">这个链接（单端口多用户）</a>，然后点击确定，批量添加完节点，然后路由选择绕过大陆，右上角开启就可以上网了。同时提供一个 ACL 地址，<a href="/link/{$acl_token}">长按复制地址</a>到客户端里应用即可。</p>
												...
												<div class="tab-pane fade {if !$ssr_prefer}active in{/if}" id="all_ss">
													...
													<div class="tab-pane fade" id="all_ss_windows">
														<p><a href="https://d.laoahong.net/sspanelv3/ssr-download/ss-win.zip">下载</a>，解压，运行程序，然后您有两种方式导入所有节点<br>
													...
													<div class="tab-pane fade" id="all_ss_mac">
														<p><a href="https://d.laoahong.net/sspanelv3/ssr-download/ss-mac.zip">下载</a>，安装，然后下载<a href="/user/getpcconf?is_mu=0&is_ss=1">这个（普通端口）</a>或者<a href="/user/getpcconf?is_mu=1&is_ss=1">这个（单端口多用户）</a>，运行程序，小飞机上右键 服务器列表 子菜单 的 “导入服务器配置文件...” 导入这个文件，然后选择一个合适的服务器，更新一下PAC，然后开启系统代理即可上网。</p>
													</div>
													...
													<div class="tab-pane fade" id="all_ss_android">
														<p><a href="https://d.laoahong.net/sspanelv3/ssr-download/ss-android.apk">下载</a>，安装，然后在手机上点击<a class="copy-text" data-clipboard-text="{$ss_url_all}">这个链接（普通端口）</a>或者<a class="copy-text" data-clipboard-text="{$ss_url_all_mu}">这个链接（单端口多用户端口）</a>复制到剪贴板，打开 Shadowsocks 客户端，选择从剪贴板导入，然后选择一个节点，设置一下路由为绕过大陆，点击飞机就可以上网了。</p>
													</div>
												</div>
											</div>
										</div>
								...
								<div class="card-main">
									<div class="card-inner margin-bottom-no">
										...
										<dl class="dl-horizontal">
											...
											<p><dt>V I P 到期时间</dt>
											{if $user->class_expire>=date('Y-m-d H:i:s',time())}
											<dd>{$user->class_expire}</dd>
											{else}
											<dd>已过期,请 <a href="/user/code">及时续费</a></dd>
											{/if}
											</p>
...
<script src="https://b.laoahong.net/sspanelv3/theme/material/js/shake.js/shake.js"></script>
