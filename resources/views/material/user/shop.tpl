					...
					<div class="card">
						<div class="card-main">
							<div class="card-inner">
								<p>购前须知：</p>
								<p><span style="bold;color:#FF00FF">系统中所有套餐的列表。您购买等级类的套餐时有效期会从当前时间开始计算；</p>
								<p><span style="bold;color:#0000FF">所有年费VIP用户流量重置日期为1号，到期日期不变，请放心购买。</p>
								<p>购买套餐之前，请先<a href="/user/code">点我充值金额</a></p>
								{*<p><span style="bold;color:#FF00FF">2018-09-16 之前，年付套餐91折（优惠码：RmwhXpTexAkefSl），购买月付套餐95折（优惠码：TkDubP6YdUGBl3ao）过期失效</p>*}
