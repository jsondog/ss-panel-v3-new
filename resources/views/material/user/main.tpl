...
<head>
	...
	<!-- css -->
	<link href="https://b.laoahong.net/sspanelv3/theme/material/css/base.min.css" rel="stylesheet">
	<link href="https://b.laoahong.net/sspanelv3/theme/material/css/project.min.css" rel="stylesheet">
	...
	<style>
		...
		.page-orange .ui-content-header {
			background-image: url(https://b.laoahong.net/sspanelv3/theme/material/css/images/bg/amber.jpg);
		}
		...
		<ul class="nav nav-list pull-right">
			<div class="dropdown margin-right">
				...
				{else}
					...
					<span class="avatar avatar-sm"><img alt="alt text for John Smith avatar" src="https://b.laoahong.net/sspanelv3/theme/material/images/users/avatar-001.jpg"></span>
					</a>
					<ul class="dropdown-menu dropdown-menu-right">
						<li>
	...
	<nav aria-hidden="true" class="menu menu-left nav-drawer nav-drawer-md" id="ui_menu" tabindex="-1">
		<div class="menu-scroll">
			<div class="menu-content">
				<a class="menu-logo" href="/user"><i class="icon icon-lg">person_pin_circle</i>&nbsp;用户面板</a>
				<ul class="nav">
					<li>
						<a class="waves-attach" data-toggle="collapse" href="#ui_menu_me">信息区</a>
						...
						<a class="waves-attach" data-toggle="collapse" href="#ui_menu_use">服务区</a>
						<ul class="menu-collapse collapse in" id="ui_menu_use">
							...
							<li>
								<a href="/user/trafficlog">
									<i class="icon icon-lg">traffic</i>&nbsp;流量使用记录
								</a>
							</li>
							
							<li>
								<a href="/user/lookingglass">
									<i class="icon icon-lg">youtube_searched_for</i>&nbsp;速度与延迟
								</a>
							</li>
						</ul>

						<a class="waves-attach" data-toggle="collapse" href="#ui_menu_detect">审查区</a>
						...
						<a class="waves-attach" data-toggle="collapse" href="#ui_menu_trade">帮助区</a>
						<ul class="menu-collapse collapse in" id="ui_menu_trade">
							...
							<li>
								<a href="/user/ticket">
									<i class="icon icon-lg">question_answer</i>&nbsp;提交工单
								</a>
							</li>
						</ul>

						
						<a class="waves-attach" data-toggle="collapse" href="#ui_menu_help">店铺区</a>
						<ul class="menu-collapse collapse in" id="ui_menu_help">
						
						
							<li>
								<a href="/user/shop">
									<i class="icon icon-lg">shop</i>&nbsp;商店购买套餐
								</a>
							</li>
							...
							<li>
								<a href="/user/code">
									<i class="icon icon-lg">code</i>&nbsp;充值金额
								</a>
							</li>
						</ul>
