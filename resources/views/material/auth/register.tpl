							...
							<div class="card-main">
								<div class="card-header">
									<div class="card-inner">
										<h1 class="card-heading">用户注册 <span style="color: red;">免费体验24小时VIP节点</span></h1>
									</div>
								</div>
								<div class="card-inner">
									<p class="text-center">
										<span class="avatar avatar-inline avatar-lg">
											<img alt="Login" src="https://b.laoahong.net/sspanelv3/theme/material/images/users/avatar-001.jpg">
										</span>
									</p>
										...
										{if $enable_invite_code == 'true'}
											<div class="form-group form-group-label">
												<div class="row">
													<div class="col-md-10 col-md-push-1">
														<label class="floating-label" for="code">请输入邀请码</label>
														<input class="form-control" id="code" type="text" value="{$code}">
													</div>
												</div>
												<div class="row">
													<div class="col-md-10 col-md-push-1">
														<p><a href="https://www.920ka.com/list/3gDs" target="_blank">邀请码购买链接</a></p>
													</div>
												</div>
											</div>
										{/if}
